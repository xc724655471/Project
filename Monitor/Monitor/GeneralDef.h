...
typedef struct STRU_ID_CH_HAND_MATCH
{

	LONG    lLoginID;				//注册ID
	int		iDeviceChan;		    //设备的通道数
	int		iPlayWindID;				//播放窗口ID
	LONG 	LPlayHandID;				//播放句柄ID
	//int 	iIPStartChan;			//数字通道起始通道号
	//int		iEnableChanNum;			//有效通道数
	//BOOL    bIPRet;                 //是否支持ip接入
...
}ID_CH_HAND_MATCH, *pID_CH_HAND_MATCH;
